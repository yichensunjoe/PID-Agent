...
export const SHORTCUT_DEFINITIONS: ShortcutDefinition[] = [
  ...
  { commandId: "workspace:group", label: "分组选中元素", defaultShortcut: "Mod+G", group: "edit" },
  { commandId: "workspace:ungroup", label: "解除选中分组", defaultShortcut: "Mod+Shift+G", group: "edit" },
  { commandId: "workspace:lock", label: "锁定选中元素", defaultShortcut: "Mod+Alt+L", group: "edit" },
  { commandId: "workspace:unlock", label: "解锁选中元素", defaultShortcut: "Mod+Alt+Shift+L", group: "edit" },
  { commandId: "workspace:invert-selection", label: "反向选择", defaultShortcut: "Mod+Shift+I", group: "edit" },
